<?php
/*Подключаем data.php*/
/*Методы: require (), require_once () подкючает только 1 раз*, include (), include_once () - в отличие от require проигнорируют факт отсутсвия файла в пути и не выдадут просто ошибку с загрузкой сайта*/
/*echo '<pre>';
    ...
    <div class="wrapper">
        ...
        <div class="main-wrapper">
            ...
            <section class="section projects-section">
                ...
                <div class="item">
                    <span class="project-title"><a href="#hook"><?=$project['name']?></a></span> - <span class="project-tagline"><?=$project['description']?></span>
                </div><!--//item-->
                <? } ?>
            </section><!--//section-->
